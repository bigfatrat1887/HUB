...
# INITIATING RICKROLL
pygame.mixer.init()
pygame.mixer.music.load("/HUB_data/definatelynotarickroll.mp3")
...
class HUB(QWidget):
    def __init__(self):
        ...
        self.count = 0
        # load UI and audio
        uic.loadUi('/HUB_data/Ui/hub.ui', self)

        # entitle the window
        self.setWindowTitle('OLD GAMES HUB')
        # create icons for buttons
        self.setWindowIcon(QtGui.QIcon('/HUB_data/Img/hubico.png'))
        self.TTR.setIcon(QIcon('/HUB_data/Img/TETRIS.png'))
        self.TTR.setIconSize(QSize(90, 90))
        self.SNK.setIcon(QIcon('/HUB_data/Img/SNAKE.png'))
        self.SNK.setIconSize(QSize(90, 90))
        self.TTT.setIcon(QIcon('/HUB_data/Img/TICTACTOE.png'))
        self.TTT.setIconSize(QSize(80, 80))
        self.SBF.setIcon(QIcon('/HUB_data/Img/GAMEPAD.png'))
        self.SBF.setIconSize(QSize(200, 200))
        self.TIR.setIcon(QIcon('/HUB_data/Img/THREE.png'))
        self.TIR.setIconSize(QSize(90, 90))
        self.REV.setIcon(QIcon('/HUB_data/Img/REVERSI.png'))
